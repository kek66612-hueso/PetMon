...
public class ProfileFragment extends Fragment {
    ...
    private void showEditDialog() {
        ...
        btnDialogSave.setOnClickListener(v -> {
            ...
            // Блокируем кнопку, пока идет отправка в облако
            btnDialogSave.setEnabled(false);
            btnDialogSave.setText("Сохранение...");
            ...
            db.collection("Users").document(currentLogin)
                    ...
                    .addOnSuccessListener(aVoid -> {
                        // Если сервер принял данные — сохраняем их в телефон
                        SharedPreferences.Editor editor = prefs.edit();
                        editor.putString("user_name", newName);
                        editor.putString("user_avatar_emoji", tempEmoji);
                        editor.apply();

                        Toast.makeText(getActivity(), "Профиль обновлен в облаке! ☁️", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(e -> {
                        ...
                        btnDialogSave.setText("Сохранить");
                        Toast.makeText(getActivity(), "Ошибка облака: " + e.getMessage(), Toast.LENGTH_LONG).show();
                    });
        });
